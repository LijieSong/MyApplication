...
import com.example.user.utils.request.okhttp.HttpsUtils;
import com.example.user.utils.request.okhttp.Param;
import com.example.user.utils.sys.NetUtils;
import java.io.File;
...
//            // 小图
    ...
    private void startRequest(Request request) {
        boolean connection = NetUtils.hasDataConnection(context);
        if (connection){
